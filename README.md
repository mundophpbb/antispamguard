...
6. Após atualizar para a versão **3.3.69**, confirme a migração em **Sobre / Diagnóstico** e revise os logs do StopForumSpam.
...
6. After updating to version **3.3.69**, confirm the migration under **About / Diagnostics** and review the StopForumSpam logs.
